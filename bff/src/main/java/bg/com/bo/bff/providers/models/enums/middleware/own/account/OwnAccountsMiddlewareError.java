...
public enum OwnAccountsMiddlewareError implements IMiddlewareError {
    ...
    MDWACM_012(HttpStatus.NOT_ACCEPTABLE, CodeError.ERROR_PROCEDURE.getCode(), "MDWACM-012", ConstantMessages.GENERIC.getMessage(), ConstantMessages.GENERIC.getTitle(), CategoryError.MW_GENERIC_INTERNAL_FAILURE.getCategoryId()),
    ...
    MDWACM_010(HttpStatus.NOT_ACCEPTABLE, CodeError.ERROR_PROCEDURE.getCode(), "MDWACM-010", ConstantMessages.GENERIC.getMessage(), ConstantMessages.GENERIC.getTitle(), CategoryError.MW_GENERIC_INTERNAL_FAILURE.getCategoryId()),
    ...
    MDWACM_021(HttpStatus.NOT_IMPLEMENTED, CodeError.INVALID_DATA.getCode(), "MDWACM-021", "Cuenta no encontrada.", "Cuenta inválida", CategoryError.MW_UNEXPECTED_FORMAT.getCategoryId()),
    MDWACM_022(HttpStatus.NOT_IMPLEMENTED, CodeError.INVALID_DATA.getCode(), "MDWACM-022", "El tipo de cuenta no es válido.", "Cuenta inválida", CategoryError.MW_UNEXPECTED_FORMAT.getCategoryId()),
    MDWACM_023(HttpStatus.NOT_IMPLEMENTED, CodeError.INVALID_DATA.getCode(), "MDWACM-023", "Cuenta no encontrada para la persona y la aplicación.", "Cuenta inválida", CategoryError.MW_UNEXPECTED_FORMAT.getCategoryId()),
