...
public enum DefaultMiddlewareError implements IMiddlewareError {
    ...
    MDWPGL_003(HttpStatus.NOT_IMPLEMENTED, CodeError.ERROR_PROCEDURE.getCode(), "MDWPGL-003", "Ocurrió un problema, error interno.", "Datos invalidos", CategoryError.MW_UNEXPECTED_FORMAT.getCategoryId()), // Error converting date format
    ...
    MDWPGL_900(HttpStatus.NOT_IMPLEMENTED, CodeError.ERROR_PROCEDURE.getCode(), "MDWPGL-900", "Ocurrió un problema, error interno.", "Ocurrio un problema", CategoryError.UNKNOWN_MW_ERROR.getCategoryId()), // No connection to BD
