...
public class AccountController {
    ...
    @Operation(summary = "Accounts Request", description = "Este es el Endpoint donde el usuario de ganamovil obtendrá sus cuentas")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Obtiene todas las cuentas, para un personId con su document-number", content = @Content(mediaType = "application/json")),
