...
@Service
public class OwnAccountMiddlewareProvider implements IAccountProvider {
    @Value("${middleware}")
    private String url;
    ...
    private static final Logger logger = LogManager.getLogger(OwnAccountMiddlewareProvider.class.getName());

    @Autowired
    public OwnAccountMiddlewareProvider(MiddlewareConfig middlewareConfig, ITokenMiddlewareProvider tokenMiddlewareProvider, IHttpClientFactory httpClientFactory, AccountListMapper accountListMapper) {
