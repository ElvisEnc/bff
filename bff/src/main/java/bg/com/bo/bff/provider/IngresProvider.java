...
@Service
public class IngresProvider implements IIngresProvider {

    private IHttpClientFactory httpClientFactory;

    private static final Logger LOGGER = LogManager.getLogger(IngresProvider.class.getName());


    public IngresProvider(IHttpClientFactory httpClientFactory) {
