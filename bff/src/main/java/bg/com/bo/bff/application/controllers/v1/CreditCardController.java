...
public class CreditCardController extends AbstractBFFController {
    ...
    public ResponseEntity<DetailCreditCardResponse> getDetailsCreditCards(
            @PathVariable("personId") @OnlyNumber @Parameter(description = "Este es el personId de la persona", example = "12345") String personId,
            @PathVariable("cardId") @OnlyNumber @Parameter(description = "Este es el cardId", example = "12345") String cardId
    ) throws IOException {
        getDeviceDataHeader();
    ...
    public ResponseEntity<CashAdvanceFeeResponse> getCashAdvanceFee(
            @PathVariable("personId") @OnlyNumber @Parameter(description = "Este es el personId de la persona", example = "12345") String personId,
            @RequestParam("amount") @Numeric(min = "1", fieldName = "amount", numericType = BigDecimal.class) @Parameter(description = "Este es el monto de la comisión", example = "100.5") String amount,
    ...
    public ResponseEntity<CashAdvanceResponse> makeCashAdvance(
            @PathVariable("personId") @OnlyNumber @Parameter(description = "Este es el personId de la persona", example = "12345") String personId,
            @PathVariable("cardId") @OnlyNumber @Parameter(description = "Este es el cardId de la cuenta de tarjeta de crédito", example = "12345") String cardId,
    ...
    public ResponseEntity<PayCreditCardResponse> paymentCreditCard(
            ...
            @PathVariable("accountId") @OnlyNumber @Parameter(description = "Este es el accountId", example = "12345") String accountId,
