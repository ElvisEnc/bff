...
public enum TransferMiddlewareError implements IMiddlewareError {
    ...
    MDWTRM_008(HttpStatus.CONFLICT, "NO_FUNDS_AVAILABLE", "MDWTRM-008", "Verifica el saldo disponible e intenta nuevamente.", "Saldo insuficiente", CategoryError.MW_GENERIC_FAIL_RESPONSE.getCategoryId()),
