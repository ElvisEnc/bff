...
@Service
public class FrequentlyQuestionProvider extends MiddlewareProvider<FrequentlyQuestionError>
        implements IFrequentlyQuestionProvider {

    private final String baseUrl;

    public FrequentlyQuestionProvider(
            ITokenMiddlewareProvider tokenMiddlewareProvider,
            MiddlewareConfig middlewareConfig,
            IHttpClientFactory httpClientFactory) {

        super(
                ProjectNameMW.USERS_QUESTIONS_MANAGER, FrequentlyQuestionError.class,
                tokenMiddlewareProvider, middlewareConfig,
                httpClientFactory, middlewareConfig.getClientUsersQuestionsManager()
        );
    ...
    public ListFrequentlyQuestionMWResponse getFrequentlyQuestions() throws IOException {
        ...
        ListFrequentlyQuestionMWResponse mwResponse = get(
                url,
                HeadersMW.getMWIdentificationChannelHeaders(),
                ListFrequentlyQuestionMWResponse.class
        );
