...
@RestController
@Validated
@RequestMapping("api/v1/own-account/transfer")
@Tag(name = "Own Account Transfer", description = "Controlador de transferencia a cuentas")
public class TransferOwnAccountController {
    @Autowired
