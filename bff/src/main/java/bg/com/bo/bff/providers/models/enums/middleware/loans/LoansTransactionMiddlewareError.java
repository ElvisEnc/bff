...
public enum LoansTransactionMiddlewareError implements IMiddlewareError {
    ...
    MDWLTM_008(HttpStatus.BAD_REQUEST, "SOURCE_ACCOUNT_KO", "MDWLTM-008", "La cuenta de origen no puede realizar débitos"),
    MDWLTM_009(HttpStatus.INTERNAL_SERVER_ERROR, "INTERNAL_SERVER_ERROR", "MDWLTM-009", "No se pudo realizar el pago"),
    MDWLTM_010(HttpStatus.BAD_REQUEST, "NOT_FOUND_AVAILABLE", "MDWLTM-010", "No se pudo realizar la conversión del monto"),
    ...
    MDWLTM_018(HttpStatus.BAD_REQUEST, "ERROR_MAE", "MDWLTM-018", "No se pudo registrar el pago"),
    MDWLTM_019(HttpStatus.BAD_REQUEST, "ERROR_MAE", "MDWLTM-019", "No se pudo registrar el pago"),
    MDWLTM_020(HttpStatus.BAD_REQUEST, "LOAN_TRANSFER_ERROR", "MDWLTM-020", "No se pudo realizar el pago del préstamo");
