...
public enum ThirdAccountMiddlewareError implements IMiddlewareError {
    ...
    MDWACTM_0007(HttpStatus.CONFLICT, "ACCOUNT_BLOCKED", "MDWACTM-0007", "La cuenta está bloqueada. Comunícate con soporte para más detalles.", "Cuenta bloqueada", CategoryError.MW_GENERIC_FAIL_RESPONSE.getCategoryId()),
