...
public enum ThirdAccountMiddlewareError implements IMiddlewareError {
    ...
    MDWACTM_0006(HttpStatus.BAD_REQUEST, "NOT_ACCOUNT", "MDWACTM-0006", "No se encontró la cuenta especificada. Revisa los datos e intenta nuevamente.", "Cuenta no encontrada"),
    ...
    MDWACTM_1002(HttpStatus.NOT_FOUND, "NOT_ACCOUNT", "MDWACTM-1002", "No se encontraron registros asociados a la cuenta.", "No hay registros"),
    ...
    MDWACTM_2007(HttpStatus.BAD_REQUEST, "BAD_REQUEST", "MDWACTM-2007", "La cuenta ya se encuentra registrada.", "Cuenta registrada"),
    ...
    MDWACTM_3002(HttpStatus.BAD_REQUEST, "BAD_REQUEST", "MDWACTM-3002", "No se encontró la cuenta con los datos proporcionados.", "Cuenta no encontrada"),
