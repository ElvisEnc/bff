...
public interface TransferMWtMapper {
    ...
    @Mappings({
            ...
            @Mapping(target = "supplementaryData.sourceOfFunds", source = "transferRequest.data.sourceOfFunds"),
            @Mapping(target = "supplementaryData.destinationOfFunds", source = "transferRequest.data.destinationOfFunds"),
