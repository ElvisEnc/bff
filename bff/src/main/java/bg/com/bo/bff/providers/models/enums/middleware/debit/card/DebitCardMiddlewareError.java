...
public enum DebitCardMiddlewareError implements IMiddlewareError {
    ...
    MDWTJD_024(HttpStatus.CONFLICT, "BAD_REQUEST", "MDWTJD-024", "El rango de fechas para compras por internet no puede ser mayor a 31 días. Ajusta el rango de fechas para continuar.", "Límite de rango excedido", CategoryError.INVALID_FORMAT.getCategoryId()),
