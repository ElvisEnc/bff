...
public enum AchTransactionMiddlewareError implements IMiddlewareError {
    ...
    MDWACH_018(HttpStatus.CONFLICT, CodeError.TRANSFER_DUPLICATE.getCode(), "MDWACH-018", ConstantMessages.TRANSFER_DUPLICATE.getMessage(), ConstantMessages.TRANSFER_DUPLICATE.getTitle(), CategoryError.MW_SPECIFIC_INTERNAL_FAILURE.getCategoryId()), // Order ACH Duplicated
