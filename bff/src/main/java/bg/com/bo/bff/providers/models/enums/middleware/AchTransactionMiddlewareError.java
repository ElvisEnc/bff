...
public enum AchTransactionMiddlewareError implements IMiddlewareError {
    MDWACH_001(HttpStatus.CONFLICT, CodeError.TRANSACTION_NOT_ALLOWED.getCode(), "MDWACH-001", ConstantMessages.TRANSACTION_NOT_ALLOWED.getMessage(), ConstantMessages.TRANSACTION_NOT_ALLOWED.getTitle(), CategoryError.MW_GENERIC_FAIL_RESPONSE.getCategoryId()),
    MDWACH_002(HttpStatus.CONFLICT, CodeError.TRANSFER_DUPLICATE.getCode(), "MDWACH-002", ConstantMessages.TRANSFER_DUPLICATE.getMessage(), ConstantMessages.TRANSFER_DUPLICATE.getTitle(), CategoryError.MW_SPECIFIC_INTERNAL_FAILURE.getCategoryId()),
    MDWACH_003(HttpStatus.NOT_ACCEPTABLE, CodeError.ERROR_TRANSFER_DUPLICATE.getCode(), "MDWACH-003", "Ocurrio un problema interno al validar la transacción duplicada.", "Ocurrió un problema", CategoryError.MW_SPECIFIC_INTERNAL_FAILURE.getCategoryId()),
    MDWACH_004(HttpStatus.NOT_ACCEPTABLE, CodeError.ERROR_TRANSFER_DUPLICATE.getCode(), "MDWACH-004", "Ocurrio un problema interno al registrar la transacción duplicada.", "Ocurrió un problema", CategoryError.MW_SPECIFIC_INTERNAL_FAILURE.getCategoryId()),
    MDWACH_005(HttpStatus.NOT_ACCEPTABLE, CodeError.VALIDATE_COMBINATION.getCode(), "MDWACH-005", ConstantMessages.VALIDATE_COMBINATION.getMessage(), ConstantMessages.VALIDATE_COMBINATION.getTitle(), CategoryError.MW_SPECIFIC_INTERNAL_FAILURE.getCategoryId()),
    ...
    MDWACH_009(HttpStatus.NOT_ACCEPTABLE, CodeError.ERROR_ITF.getCode(),  "MDWACH-009", ConstantMessages.GENERIC.getMessage(), ConstantMessages.GENERIC.getTitle(), CategoryError.MW_SPECIFIC_INTERNAL_FAILURE.getCategoryId()), // error get monto ITF
    MDWACH_010(HttpStatus.CONFLICT, CodeError.AMOUNT_LIMIT_KO.getCode(),  "MDWACH-010", ConstantMessages.AMOUNT_LIMIT_KO.getMessage(), ConstantMessages.AMOUNT_LIMIT_KO.getTitle(),CategoryError.MW_GENERIC_FAIL_RESPONSE.getCategoryId()),
    ...
    MDWACH_018(HttpStatus.NOT_ACCEPTABLE, CodeError.ERROR_PROCEDURE.getCode(), "MDWACH-018", ConstantMessages.TRANSFER_DUPLICATE.getMessage(), ConstantMessages.TRANSFER_DUPLICATE.getTitle(), CategoryError.MW_GENERIC_INTERNAL_FAILURE.getCategoryId()), // Order ACH Duplicated
    MDWACH_019(HttpStatus.CONFLICT, CodeError.FUNDS_REQUIRED.getCode(),"MDWACH-019", ConstantMessages.FUNDS_REQUIRED.getMessage(), ConstantMessages.FUNDS_REQUIRED.getTitle(), CategoryError.MW_GENERIC_FAIL_RESPONSE.getCategoryId()),
    ...
    MDWACH_029(HttpStatus.CONFLICT, CodeError.CRYPTO_FOUND.getCode(), "MDWACH-029", ConstantMessages.CRYPTO_FOUND.getMessage(), ConstantMessages.CRYPTO_FOUND.getTitle(), CategoryError.MW_GENERIC_FAIL_RESPONSE.getCategoryId()),
