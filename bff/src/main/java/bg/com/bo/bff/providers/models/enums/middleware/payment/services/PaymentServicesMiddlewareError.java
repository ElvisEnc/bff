...
public enum PaymentServicesMiddlewareError implements IMiddlewareError {
    ...
    MDWPSM_009(HttpStatus.INTERNAL_SERVER_ERROR, "ERROR_REGISTER_INTEGRATION", "MDWPSM-009", "Ocurrio un error al registar el pago."),
    MDWPSM_010(HttpStatus.INTERNAL_SERVER_ERROR, "NOT_FOUND_SEARCH_CRITERIA", "MDWPSM-010", "No se encontraron registros."),
    MDWPSM_011(HttpStatus.INTERNAL_SERVER_ERROR, "ERROR_GETTING_SERVICES", "MDWPSM-011", "Ocurrio un error al obtener los servicios afiliados"),
    MDWPSM_013(HttpStatus.INTERNAL_SERVER_ERROR, "ERROR_REGISTER_AFFILIATION", "MDWPSM-013", "Ocurrio un error en el proceso de afiliación"),
    MDWPSM_014(HttpStatus.INTERNAL_SERVER_ERROR, "ERROR_GETTING_DEBTS", "MDWPSM-014", "Ocurrio un error al obtener las deudas"),
    MDWPSM_015(HttpStatus.INTERNAL_SERVER_ERROR, "NOT_FOUND", "MDWPSM-015", "Ocurrio un error al obtener los datos."),
    MDWPSM_016(HttpStatus.INTERNAL_SERVER_ERROR, "ERROR_GETTING_MORA", "MDWPSM-016", "Ocurrio un error al obtener la mora"),
    MDWPSM_017(HttpStatus.NOT_ACCEPTABLE, "NOT_ACCEPTABLE", "MDWPSM-017", "No tiene deudas el servicio afiliado"),
    MDWPSM_018(HttpStatus.INTERNAL_SERVER_ERROR, "PAYMENT_COLLEGE_UNPROCESSED", "MDWPSM-018", "Ocurrio un error al obtener los datos."),
    MDWPSM_019(HttpStatus.INTERNAL_SERVER_ERROR, "ERROR_DELETING_AFFILIATE", "MDWPSM-019", "Error al borrar el servicio afiliado"),
    MDWPSM_020(HttpStatus.INTERNAL_SERVER_ERROR, "NOT_FOUND_DATA_IN_REDIS", "MDWPSM-020", "No se encontraron registros."),
    MDWPSM_021(HttpStatus.BAD_REQUEST, "ERROR_VERIFY_POWER_TRX", "MDWPSM-021", "Pendiente para aprovación de poderes."),
    MDWPSM_022(HttpStatus.BAD_REQUEST, "LIMIT_KO", "MDWPSM-022", "Limites de monto excedido."),
    ...
    MDWPSM_036(HttpStatus.NOT_ACCEPTABLE, "LIMIT_KO", "MDWPSM-036", "Limites transaccionales excedido."),
    MDWPSM_037(HttpStatus.NOT_ACCEPTABLE, "LIMIT_KO", "MDWPSM-037", "Limites transaccionales excedido"),
    MDWPSM_038(HttpStatus.INTERNAL_SERVER_ERROR, "INVALID_CHANNEL", "MDWPSM-038", "Canal no válido para la billetera."),
    MDWPSM_039(HttpStatus.BAD_REQUEST, "SOURCE_ACCOUNT_KO", "MDWPSM-039", "La cuenta no tiene fondos"),
    MDWPSM_043(HttpStatus.INTERNAL_SERVER_ERROR, "CANNOT_PROCESSED_AUTHORIZATION", "MDWPSM-043", "La trasacción no pudo ser procesada."),
    MDWPSM_046(HttpStatus.INTERNAL_SERVER_ERROR, "ERROR_PAYMENT_DEBT", "MDWPSM-046", "Ocurrio un error al procesar el pago"),
    MDWPSM_047(HttpStatus.BAD_REQUEST, "NOT_ACCEPTABLE", "MDWPSM-047", "Afiliación duplicada. Ya existe la afiliación"),
    MDWPSM_049(HttpStatus.INTERNAL_SERVER_ERROR, "ERROR_GETTING_TRASACCION_NUMBER", "MDWPSM-049", "Ocurrio un error al obtener los datos."),
