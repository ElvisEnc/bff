...
public class ProgrammedTransferMDWResponseFixture {

    public static ProgrammedTransferMDWResponse withDefaults() {
        return ProgrammedTransferMDWResponse.builder()
                .data(
                        Arrays.asList(
                                ProgrammedTransferMDWResponse.TransferObj.builder()
                                        .transferId(518)
                                        .personId(13649136)
