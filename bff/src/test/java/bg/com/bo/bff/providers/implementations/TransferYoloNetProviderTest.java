...
import bg.com.bo.bff.providers.dtos.request.transfer.TransferRequestProviderFixture;
...
class TransferYoloNetProviderTest {
    ...
    void givenRequestTransferWhenTransferToYoloThenSuccess() throws IOException {
        ...
        TransferYoloNetRequest requestMapperMock = TransferRequestProviderFixture.withDefaultTransferYoloNetRequest();
        TransferMWResponse responseMock = TransferMWResponseFixture.withDefault();
        ...
        // Act
        TransferMWResponse response = transferYoloNetProvider.transferToYolo(123, 123, 123, TransferRequestFixture.withDefault());
