...
import bg.com.bo.bff.services.v1.OtherAccountTransferService;

@ExtendWith(MockitoExtension.class)
public class TransferOtherAccountTest {

    private MockMvc mockMvc;
    @InjectMocks
    private TransferOtherAccountController controller;

    @Mock
    private OtherAccountTransferService services;

    private static String URL_POST = "/api/v1/other-account/transfer/persons/1234567";
