...
class TransferOwnAccountProviderTest {
    ...
    void setUp() {
        ...
        this.provider = new TransferOwnAccountProvider(httpClientFactory, middlewareConfig, tokenMiddlewareProvider, transferMapper);
    ...
    void transfer() throws IOException {
        ...
        TransferResponseMD result = provider.transfer("123455", "123", TransferRequestFixture.withDefault(), map);
    ...
    void transferError() throws IOException {
        ...
        GenericException response = assertThrows(GenericException.class, () -> provider.transfer("123455", "123", TransferRequestFixture.withDefault(), map));
