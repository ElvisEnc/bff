...
class AccountStatementMiddlewareProviderTest {
    ...
    void setUp() throws IOException {
        ...
        provider = new AccountStatementMiddlewareProvider(tokenMiddlewareProviderMock, middlewareConfig, httpClientFactoryMock);
