...
import bg.com.bo.bff.providers.dtos.request.credit.card.CreditCardMWRequestFixture;
...
class CreditCardTransactionProviderTest {
    private CreditCardTransactionProvider provider;
    ...
    void setUp() throws IOException {
        ...
        provider = new CreditCardTransactionProvider(tokenMiddlewareProviderMock, middlewareConfig, httpClientFactoryMock, httpServletRequest);
    ...
    @Test
    void givenPayCreditCardRequestWhenPayCreditCardThenExpectResponse() throws IOException {
        // Arrange
        PayCreditCardMWRequest mwRequest = CreditCardMWRequestFixture.defaultPayCreditCardMWRequest();
        PayCreditCardMWResponse expectedResponse = CreditCardMWResponseFixture.defaultPayCreditCardMWResponse();
        ...
        // Act
        PayCreditCardMWResponse response = provider.payCreditCard(mwRequest);
