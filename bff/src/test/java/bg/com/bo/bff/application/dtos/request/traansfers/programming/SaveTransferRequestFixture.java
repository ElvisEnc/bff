package bg.com.bo.bff.application.dtos.request.traansfers.programming;

import bg.com.bo.bff.application.dtos.request.transfers.programming.SaveTransferRequest;

public class SaveTransferRequestFixture {

    public static SaveTransferRequest withDefaults(){
        return SaveTransferRequest.builder()
                .originJtsOid("321654")
