...
class AccountStatementServiceTest {
    ...
    void getAccountStatementSuccess() throws IOException {
        //Arrange
        ExtractRequest mockRequest = AccountStatementRequestFixture.withDefaultExtractRequest();
        AccountReportBasicResponse mockResponse = OwnAccountMWResponseFixture.withDefaultAccountReportBasicResponse();
        ...
        //Act
        AccountStatementExtractResponse response = service.getAccountStatement(mockRequest, accountId);
